...
public partial class SoundManager : ManagerSingleton<SoundManager>
{
	...
	public static readonly string VOICE_ROOM_CUESHEET_FORMAT;
	public const string VO_CNM_PREFIX = "v/vo_cmn_";
	public const int VO_CNM_CHAR_ID_LENGTH = 4;
	private static readonly Dictionary<eVoiceType, VoiceCueParam> VOICE_CUEDATA;
	private static readonly Dictionary<SoundGroup, string[]> ASR_BUS_DATA;
	public Dictionary<int, List<string>> EventUsedBgmAssetDictionary;
	private AudioManager cuteAudioManager;
	private Action callbackPlayStoryEnd;
	private IEnumerator playStoryCoroutine;
	private AudioPlayback lastPlayedBgm;
	private AudioPlayback lastPlayedJingle;
	private AudioPlayback lastPlayedVoice;
	private int singleChannelEnvChannel;
	private string singleChannelEnvCueName;
	private string singleChannelEnvSavedCueName;
	private static readonly Dictionary<eJINGLE, SoundParam> JINGLE_PARAM_DICT;
	private static readonly Dictionary<eSEPartial, SoundParam> SE_PARAM_DICT;
	private static readonly Dictionary<string, eSEPartial> SE_CUENAME_DICT;
	...
	public static VoiceCueParam GetVoiceCueParam(eVoiceType _voiceType) { }
	...
	public void StopFadeBgm(int _channel = 0, float _fadeTime = 0.5f, Action _callback = null) { }

	public void StopFadeAllBgm(float _fadeTime = 0.5f) { }
	...
	public static SoundParam GetJingleParam(eJINGLE _type) { }
	...
	public AudioPlayback PlayVoiceTwoParam(eVoiceType _type, int _unitId, int _index) { }

	public AudioPlayback PlayVoiceLove(int _charaId, int _level, int _index) { }

	public void StopVoice(AudioPlayback _playback, float _fadeOutSec = 0, Action _onStopped = null) { }
	...
	public void PlaySeByOuterSource(CriAtomSource _seSource, bool _loop = false, string _cueSheetName = null, string _cueName = null) { }
	...
	private AudioPlayback playVoice(eVoiceType _type, int _useCueIndex, int _unitId, int _index, bool _loop = false) { }

	private AudioPlayback playVoice(int _useVoiceIndex, string _cueSheet, string _cueName, float _timeStretchRatio = 1) { }

	private void refUnitVoiceCueSheetParam(eVoiceType _type, int _unitId, int _index, ref string _cueSheet, ref string _cueName) { }

	private void refUnitSpecialVoiceCueSheetParam(eVoiceType _type, int _groupId, int _groupUnitId, int _index, ref string _cueSheet, ref string _cueName) { }
	...
	private static SoundParam searchSoundParam(eBGM _bgm) { }
...
public static class SoundDefine // TypeDefIndex: 2815
{
	// Fields
